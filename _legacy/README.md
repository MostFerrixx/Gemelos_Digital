...
| `web_dashboard/` | **ELIMINADO 2026-07-05** (ver `docs/CHANGELOG.md`) | App web huérfana (puerto 8001): 0 imports, ningún `.bat` la arranca, ruta de replay hardcodeada y obsoleta. Auditada a pedido del Director: cada idea de presentación (18+ columnas, coloreado por estado, sorting, scrubber+playback) ya estaba absorbida y ampliada en el viewer web vigente (mismos hex de color, misma estructura de columnas). Nada que rescatar -> eliminado en vez de archivado. |
