...
from web_prototype.validacion_mapa import (  # noqa: E402  (BK-36: modulo liviano)
    _celdas_bloqueadas, _cruzar_puntos, _ejemplos, _leer_mapa, _n_puntos, validar_tmx)
...
def aplicar_excel(request: AplicarRequest):
    ...
    if os.path.exists(DB_PATH):
        # BK-36: API de backup de SQLite. La base usa WAL: copiar solo el .db
        # dejaba afuera los cambios que todavia estaban en el -wal.
        from web_prototype.replicas import _copiar_base
        backup = DB_PATH + ".bak"
        _copiar_base(DB_PATH, backup)
