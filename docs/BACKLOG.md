...
| INIT-13 — Realismo calibrable (prueba contra datos reales del cliente + reloj completo + transito) | PROPUESTA (2026-09-26); diseño de A y B listo | **Alta (comercial)** | A+B ~6-7 semanas | Decisiones del Director: `docs/DISENO_INIT13_REALISMO_CALIBRABLE.md` seccion 9 |
